...
class _PartnerServiceClient implements PartnerServiceClient {
  ...
  @override
  Future<dynamic> partnerServiceCompleteOrder(
      {required PartnerCompleteOrderRequest body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<dynamic> partnerServiceFailOrder(
      {required PartnerFailOrderRequest body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  Future<PartnerGetOrderResponse> partnerServiceGetOrder(
      {required PartnerGetOrderRequest body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<PartnerGetOrderResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PartnerGetOrderResponse _value;
    try {
      _value = PartnerGetOrderResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<PartnerGetOrdersResponse> partnerServiceGetOrders(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PartnerGetOrdersResponse _value;
    try {
      _value = PartnerGetOrdersResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<dynamic> partnerServiceRejectOrder(
      {required PartnerRejectOrderRequest body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<dynamic> partnerServiceUpdateFees(
      {required PartnerUpdateFeesRequest body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
