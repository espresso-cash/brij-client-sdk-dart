...
class _StorageServiceClient implements StorageServiceClient {
  ...
  Future<V1CheckAccessResponse> storageServiceCheckAccess(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<V1CheckAccessResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = V1CheckAccessResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<V1CreateKycStatusResponse> storageServiceCreateKycStatus(
    ...
    _data.addAll(body.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<V1CreateKycStatusResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = V1CreateKycStatusResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<V1GetInfoResponse> storageServiceGetInfo(
    ...
    final value = V1GetInfoResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<V1GetKycStatusResponse> storageServiceGetKycStatus(
    ...
    _data.addAll(body.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<V1GetKycStatusResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = V1GetKycStatusResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<V1GetPartnerInfoResponse> storageServiceGetPartnerInfo(
    ...
    _data.addAll(body.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<V1GetPartnerInfoResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = V1GetPartnerInfoResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<V1GetUserDataResponse> storageServiceGetUserData(
    ...
    _data.addAll(body.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<V1GetUserDataResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = V1GetUserDataResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<V1GetWalletProofResponse> storageServiceGetWalletProof(
    ...
    _data.addAll(body.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<V1GetWalletProofResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = V1GetWalletProofResponse.fromJson(_result.data!);
    return value;
  }
