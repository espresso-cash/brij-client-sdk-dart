...
part of 'wallet_get_order_response.dart';
...
WalletGetOrderResponse _$WalletGetOrderResponseFromJson(
    Map<String, dynamic> json) {
  return _WalletGetOrderResponse.fromJson(json);
}

/// @nodoc
mixin _$WalletGetOrderResponse {
  ...
  $WalletGetOrderResponseCopyWith<WalletGetOrderResponse> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $WalletGetOrderResponseCopyWith<$Res> {
  factory $WalletGetOrderResponseCopyWith(WalletGetOrderResponse value,
          $Res Function(WalletGetOrderResponse) then) =
      _$WalletGetOrderResponseCopyWithImpl<$Res, WalletGetOrderResponse>;
  @useResult
  $Res call(
      {String orderId,
      String created,
...
/// @nodoc
class _$WalletGetOrderResponseCopyWithImpl<$Res,
        $Val extends WalletGetOrderResponse>
    implements $WalletGetOrderResponseCopyWith<$Res> {
  _$WalletGetOrderResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$WalletGetOrderResponseImplCopyWith<$Res>
    implements $WalletGetOrderResponseCopyWith<$Res> {
  factory _$$WalletGetOrderResponseImplCopyWith(
          _$WalletGetOrderResponseImpl value,
          $Res Function(_$WalletGetOrderResponseImpl) then) =
      __$$WalletGetOrderResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String orderId,
...
/// @nodoc
class __$$WalletGetOrderResponseImplCopyWithImpl<$Res>
    extends _$WalletGetOrderResponseCopyWithImpl<$Res,
        _$WalletGetOrderResponseImpl>
    implements _$$WalletGetOrderResponseImplCopyWith<$Res> {
  __$$WalletGetOrderResponseImplCopyWithImpl(
      _$WalletGetOrderResponseImpl _value,
      $Res Function(_$WalletGetOrderResponseImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$WalletGetOrderResponseImpl implements _WalletGetOrderResponse {
  const _$WalletGetOrderResponseImpl(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$WalletGetOrderResponseImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$WalletGetOrderResponseImplCopyWith<_$WalletGetOrderResponseImpl>
      get copyWith => __$$WalletGetOrderResponseImplCopyWithImpl<
          _$WalletGetOrderResponseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$WalletGetOrderResponseImplToJson(
      this,
    );
  }
}

abstract class _WalletGetOrderResponse implements WalletGetOrderResponse {
  const factory _WalletGetOrderResponse(
